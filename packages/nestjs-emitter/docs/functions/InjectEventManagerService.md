# Function: InjectEventManagerService

▸ **InjectEventManagerService**(): (`target`: `object`, `key`: `string` \| `symbol`, `index?`: `number`) => `void`
...
packages/nestjs-emitter/src/event-manager/decorators/inject.decorator.ts:6
